...
"[project]/src/app/api/orders/[id]/status/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(request, { params }) {
    try {
        ...
        const updatedOrder = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$orders$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateOrderStatus"])(id, body.status, false);
        if (!updatedOrder) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$websocket$2f$emit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["emitStatusUpdate"])(id, body.status, order.tableId);
        } catch (wsError) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__95cd5744._.js.map